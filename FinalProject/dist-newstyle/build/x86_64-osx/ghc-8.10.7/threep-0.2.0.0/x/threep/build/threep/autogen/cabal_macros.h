...
/* package threep-0.2.0.0 */
#ifndef VERSION_threep
#define VERSION_threep "0.2.0.0"
#endif /* VERSION_threep */
#ifndef MIN_VERSION_threep
#define MIN_VERSION_threep(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  2 || \
  (major1) == 0 && (major2) == 2 && (minor) <= 0)
#endif /* MIN_VERSION_threep */
...
#define CURRENT_COMPONENT_ID "threep-0.2.0.0-inplace-threep"
